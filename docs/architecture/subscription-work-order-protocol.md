...
The host bundle remains a canonical replay/interchange artefact, but it is generated by SWOS from accepted work-order submissions. It is not the primary interaction mechanism and users must not hand-assemble it.
