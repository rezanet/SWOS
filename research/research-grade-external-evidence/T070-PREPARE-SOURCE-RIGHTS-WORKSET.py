...
def stable_path(path: Path) -> str:
    """Keep generated review payloads independent of runner-local temp roots."""
    return path.name
...
def main() -> int:
    ...
    try:
            ...
            records.append(
                {
                    ...
                    "source_binding": {
                        ...
                        "acquired_copy_uri": source.get("content_uri")
                        or source.get("acquired_copy_uri"),
                        "manifest_expected_sha256": source.get("expected_sha256")
        ...
        if not records:
            raise ValueError("source manifest must contain at least one source record")
        ...
        payload = {
            ...
            "source_manifest_path": stable_path(manifest_path),
            "source_manifest_sha256": sha256_file(manifest_path),
