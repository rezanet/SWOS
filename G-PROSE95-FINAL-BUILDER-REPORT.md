...
| Final code/evidence head | deb60c0db5e4899d21549e6daeb274546a2c8a75 |
| Final code fixes | a5808c76c56d0081eb20a9596b16ce982c740f0f — preserve unary context operators; 9d86ecb94d0e7726a30c9bb2dface72894176fcf — close wrapper and budget provenance gaps; 2b9b52a70b4ec563b98fe668cebd63fe6330f554 — guard Markdown link-label context claims; deb60c0db5e4899d21549e6daeb274546a2c8a75 — preserve punctuation inside closing context delimiters |
...
| Item | Exact value |
|---|---|
| Workflow run | 32599944576 — success |
| Exact head | deb60c0db5e4899d21549e6daeb274546a2c8a75 |
| Corpus contract job | 97096608775 — success |
| Live evidence job | 97096608663 — success |
| Artifact | swos-prose-g-prose95-benchmark, ID 9482812984 |
| Generated at | 2026-08-22T21:33:55.826308Z |
...
| Equivalent statuses | PASS 26, REJECT 5, REVIEW 7 |
| Material-change statuses | REJECT 25, REPAIR 13 |
| Safety gate | true |
| Verifier calls | 44 |
| Total latency | 316,508.470 ms |
| Average latency | 4,164.585 ms |
...
- baseline tokens without diagnostics: input 105,479 / output 18,981 / total 124,460;
- counterfactual tokens with diagnostics: input 100,849 / output 17,937 / total 118,786;
- tokens saved: input 4,630 / output 1,044 / total 5,674;
- total token savings: 4.558894423911297%;
- baseline calls: rewrite 76, verifier 19, repair 0, total 95;
- calls saved by diagnostics: rewrite 3, verifier 1, repair 0, total 4;
- counterfactual calls: rewrite 73, verifier 18, repair 0, total 91;
- efficiency latency: 224,315.571 ms total, 2,951.521 ms average;
- efficiency unsafe abstentions: 0;
- repair records: 76 not attempted, 0 provider calls, 1 source fallback, attempt distribution {"0": 76};
...
polish::none                  56: PASS 55, REVIEW 1
...
- verifier calls: 80;
- total latency: 483,195.763 ms;
- average latency: 6,039.947 ms;
- cost: unavailable;
...
| Gate | Result |
|---|---|
| Prose unit/contract suite | 237 tests, 11 expected live skips, OK |
| Executable coverage | 86.03%; policy PASS |
...
|---|---|---|
| SWOS CI | run 32599881493; DCO 97096457023; schema 97096456924; skills 97096457038; prose tests 97096457004; governance 97096457046; OpenAI live 97096457010; eval jobs 97096482295, 97096482224, 97096482169, 97096482164, 97096482209, 97096482235, 97096482226, 97096482179 | success |
...
- this report records the final hosted evidence from deb60c0;
...
The implementation/evidence diff from 2004efd5ac444e5eb639ac77e7eebcbabb6573a6 to the final code head contains 53 files, 2,830 insertions, and 161 deletions, excluding this report file:
